...
def GetArgs():
    ...
    try:
        ...
        if not compute_forest_edge_effects:
            ...
            args = {
                u'lulc_raster_path': lulc_uri,
                u'biophysical_table_path': biophysical_table_uri,
        ...
        #COMPUTE FOREST EDGE EFFECTS
            ...
            args = {
                ...
                u'tropical_forest_edge_carbon_model_vector_path': tropical_forest_edge_carbon_model_shape_uri,
        ...
        if aoi_uri and aoi_uri != "#":
            args[u'aoi_vector_path'] = aoi_uri
...
if __name__ == '__main__':
    ...
    DefineProj(args[u'lulc_raster_path'], outCarbon_rast)
    #### Set Parameters ####
    ...
    if 'aoi_vector_path' in args:
        ...
        DefineProj(args[u'lulc_raster_path'], outAggrCstock_shp)

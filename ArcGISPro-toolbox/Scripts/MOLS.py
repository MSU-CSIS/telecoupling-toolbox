...
#Parameters = (r"C:\ArcGisPro_Tools\SampleData_ArcGIS_v2.3\SampleData_ArcGIS_v2.3\Causes\Model Selection OLS\gtgp_hhsurvey_2006.shp", "Crop_produ", "GTBP;GTGP;Log__dista;Number_of;Tourism_pa", None, r"C:\arcgistoolboxTest\1.txt", 5, 1, 0.5, 0.05, 7.5, 0.1, 0.1)
#ARCPY.env.overwriteOutput = True
#inputFC = Parameters[0]
#dependentVar =  Parameters[1].upper()
#independentVarsReg = Parameters[2]
#independentVars = independentVarsReg.upper().split(";")
#weightsFile = Parameters[3]

#### Derived Output ####
outputReportFile = OS.path.join(ARCPY.env.scratchFolder, "ModelSelectionOLS.txt")

#### Search Criterion ####
#maxIndVars = Parameters[5]
#minIndVars = Parameters[6]
#minR2 = Parameters[7]
#maxCoef = Parameters[8]
#maxVIF =Parameters[9]
#minJB = Parameters[10]
#minMI =Parameters[11]

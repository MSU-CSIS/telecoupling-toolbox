...
* Open ArcMap
* Right-click on the ArcToolbox folder and select "Add Toolbox"
* Browse to the unzipped folder of the telecoupling project and select `Telecoupling Tools v1.2.1a.tbx`
